...
%post
sed -i 's|^gratia.reporting.version.*=|gratia.reporting.version = v%{version}-%{release}\n#gratia.reporting.version=|' %{_sysconfdir}/gratia/collector/service-configuration.properties
sed -i 's|^gratia.services.version.*=|gratia.services.version = v%{version}-%{release}\n#gratia.services.version=|'    %{_sysconfdir}/gratia/collector/service-configuration.properties
sed -i 's|^gratia.reporting.version.*=|gratia.reporting.version = v%{version}-%{release}\n#gratia.reporting.version=|' %{_sysconfdir}/gratia/collector/service-authorization.properties
sed -i 's|^gratia.services.version.*=|gratia.services.version = v%{version}-%{release}\n#gratia.services.version=|'    %{_sysconfdir}/gratia/collector/service-authorization.properties
