...
public class ClusterNameCorrection extends HttpServlet {
    ...
    public void update(int index, HttpServletRequest request)
    {
        ...
        int clusterid = Integer.parseInt((String) clusterbyname.get(actualname));
    ...
    public void insert(int index, HttpServletRequest request)
    {
        ...
        int clusterid = Integer.parseInt((String) clusterbyname.get(actualname));
        String name = request.getParameter("clustername:" + index);
        int type = Integer.parseInt(request.getParameter("aggtype:" + index));
