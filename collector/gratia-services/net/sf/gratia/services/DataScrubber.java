...
public class DataScrubber {
   ...
   protected long ExecuteSQL( String deletecmd, String limit, String msg )
   {
      ...
      } while ((deletedThisIteration == fBatchSize) && (!fStopRequested));
   ...
   public long MasterServiceSummary() {
      return GenericSummary("MasterServiceSummary","service summary");
   }

   public long MasterServiceSummaryHourly() {
      return GenericSummary("MasterServiceSummaryHourly","service summary hourly");
   }
